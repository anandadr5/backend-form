  ...
  "perpanjangan_spk_approval": {
    ...
    getHtmlBody: (data) => `
      <div style="font-family: Arial, sans-serif; font-size: 11pt; line-height: 1.6;">
        ...
        <p>Dengan hormat,<br>Diajukan permintaan perpanjangan SPK yang memerlukan persetujuan Anda dengan rincian sebagai berikut:</p>
        <table cellpadding="5" style="font-family: Arial, sans-serif; font-size: 11pt;">
          <tr>
            <td style="vertical-align: top; width: 150px;"><strong>Nomor Ulok</strong></td>
            <td style="vertical-align: top;">: ${data.nomor_ulok}</td>
          </tr>
          <tr>
            <td style="vertical-align: top;"><strong>Pertambahan Hari</strong></td>
            <td style="vertical-align: top;">: ${data.pertambahan_hari} hari</td>
          </tr>
          <tr>
            <td style="vertical-align: top;"><strong>Diajukan Oleh</strong></td>
            <td style="vertical-align: top;">: ${data.dibuat_oleh_nama}</td>
          </tr>
          <tr>
            <td style="vertical-align: top;"><strong>Alasan</strong></td>
            <td style="vertical-align: top;">: <div style="margin-left: 5px;">${data.alasan_spk.replace(/\n/g, '<br/>')}</div></td>
          </tr>
          <tr>
            <td style="vertical-align: top;"><strong>Detail Laporan</strong></td>
            <td style="vertical-align: top;">: <a href="${data.pdfUrl}" target="_blank">Lihat Dokumen (PDF)</a></td>
          </tr>
        </table>
        <p>Mohon untuk memberikan keputusan dengan memilih salah satu tautan di bawah ini:</p>
        <p>
          &nbsp;&nbsp;&nbsp;1. <a href="${data.approveUrl}" style="color: #0000EE;"><strong>SETUJUI PERMINTAAN</strong></a><br>
          &nbsp;&nbsp;&nbsp;2. <a href="${data.rejectUrl}" style="color: #0000EE;"><strong>TOLAK PERMINTAAN</strong></a>
        </p>
    ...
    getSubject: (data) => `[NOTIFIKASI] Respon Perpanjangan SPK untuk Toko: ${data.nomor_ulok}`,
    getRecipients: (data) => data.recipients,
    getHtmlBody: (data) => `
      <div style="font-family: Arial, sans-serif; font-size: 11pt; line-height: 1.6;">
        <p>Yth. Bapak/Ibu,</p>
        <p>Dengan ini kami informasikan bahwa permintaan perpanjangan SPK untuk Nomor Ulok <strong>${data.nomor_ulok}</strong> telah direspon.</p>
        <p>Berikut adalah detailnya:</p>
        <table cellpadding="5" style="font-family: Arial, sans-serif; font-size: 11pt;">
          <tr>
            <td style="width: 170px;"><strong>Status</strong></td>
            <td>: <strong>${data.status.toUpperCase()}</strong></td>
          </tr>
          <tr>
            <td><strong>Ditinjau Oleh</strong></td>
            <td>: ${data.disetujui_oleh}</td>
          </tr>
          <tr>
            <td><strong>Waktu Respon</strong></td>
            <td>: ${new Date(data.waktu_persetujuan).toLocaleString('id-ID', { dateStyle: 'full', timeStyle: 'long' })}</td>
          </tr>
          ${data.status === 'ditolak' ? `
          <tr>
            <td style="vertical-align: top;"><strong>Alasan Penolakan</strong></td>
            <td style="vertical-align: top;">: ${data.alasan_penolakan}</td>
          </tr>
          ` : ''}
          <tr>
            <td><strong>Dokumen Final</strong></td>
            <td>: <a href="${data.link_pdf}" target="_blank">Lihat Laporan Final (PDF)</a></td>
          </tr>
        </table>
