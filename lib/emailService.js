...
"serah-terima-kontraktor": {
  ...
  "perpanjangan_spk_approval": {
      ...
      getHtmlBody: (data) => `
        <div style="font-family: Arial, sans-serif; line-height: 1.6;">
          ...
          <ul>
            ...
            ${
                  data.link_lampiran_user && data.link_lampiran_user !== '-' && data.link_lampiran_user !== '' 
                  ? `<li><strong>Lampiran Pendukung:</strong> <a href="${data.link_lampiran_user}" target="_blank">Lihat File</a></li>` 
                  : ''
                }
          </ul>
    ...
    getHtmlBody: (data) => {
        ...
        if (data.regional_nama) namaPenerima.push(`<strong>${data.regional_nama}</strong>`);
