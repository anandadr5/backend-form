    ...
    getHtmlBody: (data) => {
      ...
      return `
        <div style="font-family: Arial, sans-serif; line-height: 1.6;">
          ...
          <p>📄 <a href="${data.pdfUrl || '#'}" target="_blank">Lihat Dokumen RAB/Penawaran PDF</a></p>
          ${
            data.sphUrl ? // BARU: Tambahkan link SPH
            `<p>📄 <a href="${data.sphUrl || '#'}" target="_blank">Lihat Dokumen SPH PDF</a></p>`
            : ''
          }
