...
const emailTemplates = {
  ...
  "perpanjangan_spk_approval": {
      ...
      getHtmlBody: (data) => `
        <div style="font-family: Arial, sans-serif; line-height: 1.6;">
          ...
          <ul>
            ...
            <li><strong>Tanggal SPK Akhir (Original):</strong> ${formatIndoDate(data.tanggal_spk_akhir)}</li>
            <li><strong>Pertambahan Hari:</strong> ${data.pertambahan_hari} hari</li>
            <li><strong>Tanggal SPK Akhir (Baru):</strong> ${formatIndoDate(data.tanggal_spk_akhir_baru)}</li>
    ...
    getHtmlBody: (data) => {
        ...
        const statusWarna = data.status_persetujuan === 'DISETUJU' ? 'green' : 'red';
        ...
        <div style="font-family: Arial, sans-serif; line-height: 1.6;">
            ...
            <ul>
                ...
                <li style="margin-top: 10px;"><strong>Tanggal SPK Akhir (Original):</strong> ${formatIndoDate(data.tanggal_spk_akhir)}</li>
                <li><strong>Pertambahan Hari:</strong> ${data.pertambahan_hari} hari</li>
                <li><strong>Tanggal SPK Akhir (Baru):</strong> ${formatIndoDate(data.tanggal_spk_akhir_setelah_perpanjangan)}</li>
