...
function generateCommonEmailBody(
  ...
  const isSerahTerima = formType === "serah-terima";
  ...
  if (isSerahTerima && data.isContractorOnlyNotification && generalSalamNameParts.length > 0) {
      generalSalamNama = `Bapak/Ibu <strong>${data.kontraktor_nama}</strong>`;
  } else if (isSerahTerima && !isRejected && generalSalamNameParts.length >= 4) {
